...
#
$RequiredBicepCliVersion = "0.11.1"                # ensures the build uses a consistent version of the Bicep tooling
...
task PreTest {
    ...
    if (!(Get-Module -ListAvailable PSRule.Rules.Azure)) { Install-Module PSRule.Rules.Azure -Force }
